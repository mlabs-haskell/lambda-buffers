...
module Proto.LambdabuffersCompilerService_Fields where
...
compiled ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "compiled" a) =>
  Lens.Family2.LensLike' f s a
compiled = Data.ProtoLens.Field.field @"compiled"
diagnostics ::
  forall f s a.
  (Prelude.Functor f,
...
maybe'compiled ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'compiled" a) =>
  Lens.Family2.LensLike' f s a
maybe'compiled = Data.ProtoLens.Field.field @"maybe'compiled"
maybe'diagnostics ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'diagnostics" a) =>
  Lens.Family2.LensLike' f s a
maybe'diagnostics = Data.ProtoLens.Field.field @"maybe'diagnostics"
maybe'source ::
  forall f s a.
  (Prelude.Functor f,
