  ...
  describe("Foo tests", () => {
    it(`Foo.A from to golden tests`, async () => {
      await Utils.fromToGoldenTest(
        ...
        Utils.mkFromToAssertGolden(
          ...
          (v) =>
            LbrPlutusV1
              .IsPlutusData[LbfFoo.A]
              .fromData(LbrPrelude.Json[LbrPlutusV1.PlutusData]
                .fromJson(v)),
          (v) =>
    ...
    it(`Foo.FInt from to golden tests`, async () => {
      await Utils.fromToGoldenTest(
        goldenDir,
        new Utils.RegExpFileFilter(
          /^Foo\.FInt\.[0-9]*\.pd\.json$/g,
        ),
        Utils.mkFromToAssertGolden(
          PreludeJson.parseJson,
          (v) =>
            LbrPlutusV1
              .IsPlutusData[LbfFoo.FInt]
              .fromData(LbrPrelude.Json[LbrPlutusV1.PlutusData]
                .fromJson(v)),
          (v) =>
            LbrPrelude.Json[LbrPlutusV1.PlutusData].toJson(
    ...
    it(`Foo.GInt from to golden tests`, async () => {
      await Utils.fromToGoldenTest(
        goldenDir,
        new Utils.RegExpFileFilter(
          /^Foo\.GInt\.[0-9]*\.pd\.json$/g,
        ),
        Utils.mkFromToAssertGolden(
          PreludeJson.parseJson,
          (v) =>
            LbrPlutusV1
              .IsPlutusData[LbfFoo.GInt]
              .fromData(LbrPrelude.Json[LbrPlutusV1.PlutusData]
                .fromJson(v)),
          (v) =>
            LbrPrelude.Json[LbrPlutusV1.PlutusData].toJson(
  ...
  describe("Day tests", () => {
    it(`Days.Day from to golden tests`, async () => {
      await Utils.fromToGoldenTest(
        goldenDir,
        new Utils.RegExpFileFilter(
          /^Days\.Day\.[0-9]*\.pd\.json$/g,
        ),
        Utils.mkFromToAssertGolden(
          PreludeJson.parseJson,
          (v) =>
            LbrPlutusV1
              .IsPlutusData[LbfDays.Day]
              .fromData(LbrPrelude.Json[LbrPlutusV1.PlutusData]
                .fromJson(v)),
          (v) =>
            LbrPrelude.Json[LbrPlutusV1.PlutusData].toJson(
    ...
    it(`Days.WorkDay from to golden tests`, async () => {
      await Utils.fromToGoldenTest(
        goldenDir,
        new Utils.RegExpFileFilter(
          /^Days\.WorkDay\.[0-9]*\.pd\.json$/g,
        ),
        Utils.mkFromToAssertGolden(
          PreludeJson.parseJson,
          (v) =>
            LbrPlutusV1
              .IsPlutusData[LbfDays.WorkDay]
              .fromData(LbrPrelude.Json[LbrPlutusV1.PlutusData]
                .fromJson(v)),
          (v) =>
            LbrPrelude.Json[LbrPlutusV1.PlutusData].toJson(
    ...
    it(`Days.FreeDay from to golden tests`, async () => {
      await Utils.fromToGoldenTest(
        goldenDir,
        new Utils.RegExpFileFilter(
          /^Days\.FreeDay\.[0-9]*\.pd\.json$/g,
        ),
        Utils.mkFromToAssertGolden(
          PreludeJson.parseJson,
          (v) =>
            LbrPlutusV1
              .IsPlutusData[LbfDays.FreeDay]
              .fromData(LbrPrelude.Json[LbrPlutusV1.PlutusData]
                .fromJson(v)),
          (v) =>
            LbrPrelude.Json[LbrPlutusV1.PlutusData].toJson(
  ...
  describe("Plutus tests", () => {
    it(`PlutusV1.PlutusData from to golden tests`, async () => {
      await Utils.fromToGoldenTest(
        goldenDir,
        new Utils.RegExpFileFilter(
          /^PlutusV1\.PlutusData\.[0-9]*\.pd\.json$/g,
        ),
        Utils.mkFromToAssertGolden(
          PreludeJson.parseJson,
          (v) =>
            LbrPlutusV1
              .IsPlutusData[LbrPlutusV1.PlutusData]
              .fromData(LbrPrelude.Json[LbrPlutusV1.PlutusData]
                .fromJson(v)),
          (v) =>
            LbrPrelude.Json[LbrPlutusV1.PlutusData].toJson(
    ...
    it(`PlutusV1.Address from to golden tests`, async () => {
      await Utils.fromToGoldenTest(
        goldenDir,
        new Utils.RegExpFileFilter(
          /^PlutusV1\.Address\.[0-9]*\.pd\.json$/g,
        ),
        Utils.mkFromToAssertGolden(
          PreludeJson.parseJson,
          (v) =>
            LbrPlutusV1
              .IsPlutusData[LbrPlutusV1.Address]
    ...
    it(`PlutusV1.Credential from to golden tests`, async () => {
      await Utils.fromToGoldenTest(
        goldenDir,
        new Utils.RegExpFileFilter(
          /^PlutusV1\.Credential\.[0-9]*\.pd\.json$/g,
        ),
        Utils.mkFromToAssertGolden(
          PreludeJson.parseJson,
          (v) =>
            LbrPlutusV1
              .IsPlutusData[LbrPlutusV1.Credential]
              .fromData(LbrPrelude.Json[LbrPlutusV1.PlutusData].fromJson(v)),
          (v) =>
            LbrPrelude.Json[LbrPlutusV1.PlutusData].toJson(
              LbrPlutusV1
    ...
    it(`PlutusV1.StakingCredential from to golden tests`, async () => {
      await Utils.fromToGoldenTest(
        ...
        Utils.mkFromToAssertGolden(
          ...
          (v) =>
            LbrPlutusV1
              .IsPlutusData[LbrPlutusV1.StakingCredential]
              .fromData(LbrPrelude.Json[LbrPlutusV1.PlutusData].fromJson(v)),
          (v) =>
            LbrPrelude.Json[LbrPlutusV1.PlutusData].toJson(
              LbrPlutusV1
    ...
    it(`PlutusV1.PubKeyHash from to golden tests`, async () => {
      await Utils.fromToGoldenTest(
        goldenDir,
        new Utils.RegExpFileFilter(
          /^PlutusV1\.PubKeyHash\.[0-9]*\.pd\.json$/g,
        ),
        Utils.mkFromToAssertGolden(
          PreludeJson.parseJson,
          (v) =>
            LbrPlutusV1
              .IsPlutusData[LbrPlutusV1.PubKeyHash]
              .fromData(LbrPrelude.Json[LbrPlutusV1.PlutusData].fromJson(v)),
          (v) =>
            LbrPrelude.Json[LbrPlutusV1.PlutusData].toJson(
              LbrPlutusV1
    ...
    it(`PlutusV1.Bytes from to golden tests`, async () => {
      await Utils.fromToGoldenTest(
        goldenDir,
        new Utils.RegExpFileFilter(
          /^PlutusV1\.Bytes\.[0-9]*\.pd\.json$/g,
        ),
        Utils.mkFromToAssertGolden(
          PreludeJson.parseJson,
          (v) =>
            LbrPlutusV1
              .IsPlutusData[LbrPlutusV1.LedgerBytes]
              .fromData(LbrPrelude.Json[LbrPlutusV1.PlutusData].fromJson(v)),
          (v) =>
            LbrPrelude.Json[LbrPlutusV1.PlutusData].toJson(
              LbrPlutusV1
    ...
    it(`PlutusV1.Interval from to golden tests`, async () => {
      await Utils.fromToGoldenTest(
        goldenDir,
        new Utils.RegExpFileFilter(
          /^PlutusV1\.Interval\.[0-9]*\.pd\.json$/g,
        ),
        Utils.mkFromToAssertGolden(
          PreludeJson.parseJson,
          (v) =>
            LbrPlutusV1
              .IsPlutusData[LbrPlutusV1.Interval](
    ...
    it(`PlutusV1.Extended from to golden tests`, async () => {
      await Utils.fromToGoldenTest(
        goldenDir,
        new Utils.RegExpFileFilter(
          /^PlutusV1\.Extended\.[0-9]*\.pd\.json$/g,
        ),
        Utils.mkFromToAssertGolden(
          PreludeJson.parseJson,
          (v) =>
            LbrPlutusV1
              .IsPlutusData[LbrPlutusV1.Extended](
                LbrPlutusV1.IsPlutusData[LbrPlutusV1.POSIXTime],
              )
              .fromData(LbrPrelude.Json[LbrPlutusV1.PlutusData].fromJson(v)),
          (v) =>
    ...
    it(`PlutusV1.LowerBound from to golden tests`, async () => {
      await Utils.fromToGoldenTest(
        goldenDir,
        new Utils.RegExpFileFilter(
          /^PlutusV1\.LowerBound\.[0-9]*\.pd\.json$/g,
        ),
        Utils.mkFromToAssertGolden(
          PreludeJson.parseJson,
          (v) =>
            LbrPlutusV1
              .IsPlutusData[LbrPlutusV1.LowerBound](
                LbrPlutusV1.IsPlutusData[LbrPlutusV1.POSIXTime],
              )
              .fromData(LbrPrelude.Json[LbrPlutusV1.PlutusData].fromJson(v)),
          (v) =>
    ...
    it(`PlutusV1.UpperBound from to golden tests`, async () => {
      await Utils.fromToGoldenTest(
        goldenDir,
        new Utils.RegExpFileFilter(
          /^PlutusV1\.UpperBound\.[0-9]*\.pd\.json$/g,
        ),
        Utils.mkFromToAssertGolden(
          PreludeJson.parseJson,
          (v) =>
            LbrPlutusV1
              .IsPlutusData[LbrPlutusV1.UpperBound](
                LbrPlutusV1.IsPlutusData[LbrPlutusV1.POSIXTime],
              )
              .fromData(LbrPrelude.Json[LbrPlutusV1.PlutusData].fromJson(v)),
          (v) =>
    ...
    it(`PlutusV1.POSIXTime from to golden tests`, async () => {
      await Utils.fromToGoldenTest(
        goldenDir,
        new Utils.RegExpFileFilter(
          /^PlutusV1\.POSIXTime\.[0-9]*\.pd\.json$/g,
        ),
        Utils.mkFromToAssertGolden(
          PreludeJson.parseJson,
          (v) =>
            LbrPlutusV1
              .IsPlutusData[LbrPlutusV1.POSIXTime]
              .fromData(LbrPrelude.Json[LbrPlutusV1.PlutusData].fromJson(v)),
          (v) =>
            LbrPrelude.Json[LbrPlutusV1.PlutusData].toJson(
              LbrPlutusV1
    ...
    it(`PlutusV1.POSIXTimeRange from to golden tests`, async () => {
      await Utils.fromToGoldenTest(
        ...
        Utils.mkFromToAssertGolden(
          ...
          (v) =>
            LbrPlutusV1
              .IsPlutusData[LbrPlutusV1.POSIXTimeRange]
              .fromData(LbrPrelude.Json[LbrPlutusV1.PlutusData].fromJson(v)),
          (v) =>
            LbrPrelude.Json[LbrPlutusV1.PlutusData].toJson(
              LbrPlutusV1
    ...
    it(`PlutusV1.CurrencySymbol from to golden tests`, async () => {
      await Utils.fromToGoldenTest(
        ...
        Utils.mkFromToAssertGolden(
          ...
          (v) =>
            LbrPlutusV1
              .IsPlutusData[LbrPlutusV1.CurrencySymbol]
              .fromData(LbrPrelude.Json[LbrPlutusV1.PlutusData].fromJson(v)),
          (v) =>
            LbrPrelude.Json[LbrPlutusV1.PlutusData].toJson(
              LbrPlutusV1
    ...
    it(`PlutusV1.TokenName from to golden tests`, async () => {
      await Utils.fromToGoldenTest(
        goldenDir,
        new Utils.RegExpFileFilter(
          /^PlutusV1\.TokenName\.[0-9]*\.pd\.json$/g,
        ),
        Utils.mkFromToAssertGolden(
          PreludeJson.parseJson,
          (v) =>
            LbrPlutusV1
              .IsPlutusData[LbrPlutusV1.TokenName]
              .fromData(LbrPrelude.Json[LbrPlutusV1.PlutusData].fromJson(v)),
          (v) =>
            LbrPrelude.Json[LbrPlutusV1.PlutusData].toJson(
              LbrPlutusV1
    ...
    it(`PlutusV1.AssetClass from to golden tests`, async () => {
      await Utils.fromToGoldenTest(
        goldenDir,
        new Utils.RegExpFileFilter(
          /^PlutusV1\.AssetClass\.[0-9]*\.pd\.json$/g,
        ),
        Utils.mkFromToAssertGolden(
          PreludeJson.parseJson,
          (v) =>
            LbrPlutusV1
              .IsPlutusData[LbrPlutusV1.AssetClass]
              .fromData(LbrPrelude.Json[LbrPlutusV1.PlutusData].fromJson(v)),
          (v) =>
            LbrPrelude.Json[LbrPlutusV1.PlutusData].toJson(
              LbrPlutusV1
    ...
    it(`PlutusV1.Value from to golden tests`, async () => {
      await Utils.fromToGoldenTest(
        goldenDir,
        new Utils.RegExpFileFilter(
          /^PlutusV1\.Value\.[0-9]*\.pd\.json$/g,
        ),
        Utils.mkFromToAssertGolden(
          PreludeJson.parseJson,
          (v) =>
            LbrPlutusV1
              .IsPlutusData[LbrPlutusV1.Value]
              .fromData(LbrPrelude.Json[LbrPlutusV1.PlutusData].fromJson(v)),
          (v) =>
            LbrPrelude.Json[LbrPlutusV1.PlutusData].toJson(
              LbrPlutusV1
    ...
    it(`PlutusV1.Redeemer from to golden tests`, async () => {
      await Utils.fromToGoldenTest(
        goldenDir,
        new Utils.RegExpFileFilter(
          /^PlutusV1\.Redeemer\.[0-9]*\.pd\.json$/g,
        ),
        Utils.mkFromToAssertGolden(
          PreludeJson.parseJson,
          (v) =>
            LbrPlutusV1
              .IsPlutusData[LbrPlutusV1.Redeemer]
              .fromData(LbrPrelude.Json[LbrPlutusV1.PlutusData].fromJson(v)),
          (v) =>
            LbrPrelude.Json[LbrPlutusV1.PlutusData].toJson(
              LbrPlutusV1
    ...
    it(`PlutusV1.Datum from to golden tests`, async () => {
      await Utils.fromToGoldenTest(
        goldenDir,
        new Utils.RegExpFileFilter(
          /^PlutusV1\.Datum\.[0-9]*\.pd\.json$/g,
        ),
        Utils.mkFromToAssertGolden(
          PreludeJson.parseJson,
          (v) =>
            LbrPlutusV1
              .IsPlutusData[LbrPlutusV1.Datum]
              .fromData(LbrPrelude.Json[LbrPlutusV1.PlutusData].fromJson(v)),
          (v) =>
            LbrPrelude.Json[LbrPlutusV1.PlutusData].toJson(
              LbrPlutusV1
    ...
    it(`PlutusV1.RedeemerHash from to golden tests`, async () => {
      await Utils.fromToGoldenTest(
        ...
        Utils.mkFromToAssertGolden(
          ...
          (v) =>
            LbrPlutusV1
              .IsPlutusData[LbrPlutusV1.RedeemerHash]
              .fromData(LbrPrelude.Json[LbrPlutusV1.PlutusData].fromJson(v)),
          (v) =>
            LbrPrelude.Json[LbrPlutusV1.PlutusData].toJson(
              LbrPlutusV1
    ...
    it(`PlutusV1.DatumHash from to golden tests`, async () => {
      await Utils.fromToGoldenTest(
        goldenDir,
        new Utils.RegExpFileFilter(
          /^PlutusV1\.DatumHash\.[0-9]*\.pd\.json$/g,
        ),
        Utils.mkFromToAssertGolden(
          PreludeJson.parseJson,
          (v) =>
            LbrPlutusV1
              .IsPlutusData[LbrPlutusV1.DatumHash]
              .fromData(LbrPrelude.Json[LbrPlutusV1.PlutusData].fromJson(v)),
          (v) =>
            LbrPrelude.Json[LbrPlutusV1.PlutusData].toJson(
              LbrPlutusV1
    ...
    it(`PlutusV1.ScriptHash from to golden tests`, async () => {
      await Utils.fromToGoldenTest(
        goldenDir,
        new Utils.RegExpFileFilter(
          /^PlutusV1\.ScriptHash\.[0-9]*\.pd\.json$/g,
        ),
        Utils.mkFromToAssertGolden(
          PreludeJson.parseJson,
          (v) =>
            LbrPlutusV1
              .IsPlutusData[LbrPlutusV1.ScriptHash]
              .fromData(LbrPrelude.Json[LbrPlutusV1.PlutusData].fromJson(v)),
          (v) =>
            LbrPrelude.Json[LbrPlutusV1.PlutusData].toJson(
              LbrPlutusV1
    ...
    it(`PlutusV1.TxId from to golden tests`, async () => {
      await Utils.fromToGoldenTest(
        goldenDir,
        new Utils.RegExpFileFilter(
          /^PlutusV1\.TxId\.[0-9]*\.pd\.json$/g,
        ),
        Utils.mkFromToAssertGolden(
          PreludeJson.parseJson,
          (v) =>
            LbrPlutusV1
              .IsPlutusData[LbrPlutusV1.TxId]
              .fromData(LbrPrelude.Json[LbrPlutusV1.PlutusData].fromJson(v)),
          (v) =>
            LbrPrelude.Json[LbrPlutusV1.PlutusData].toJson(
              LbrPlutusV1
    ...
    it(`PlutusV1.TxOutRef from to golden tests`, async () => {
      await Utils.fromToGoldenTest(
        goldenDir,
        new Utils.RegExpFileFilter(
          /^PlutusV1\.TxOutRef\.[0-9]*\.pd\.json$/g,
        ),
        Utils.mkFromToAssertGolden(
          PreludeJson.parseJson,
          (v) =>
            LbrPlutusV1
              .IsPlutusData[LbrPlutusV1.TxOutRef]
              .fromData(LbrPrelude.Json[LbrPlutusV1.PlutusData].fromJson(v)),
          (v) =>
            LbrPrelude.Json[LbrPlutusV1.PlutusData].toJson(
              LbrPlutusV1
    ...
    // TODO(jaredponn) TxInInfo V1 missing
    // TODO(jaredponn) TxOut V1 missing

    it(`PlutusV2.TxInInfo from to golden tests`, async () => {
      await Utils.fromToGoldenTest(
        goldenDir,
        new Utils.RegExpFileFilter(
          /^PlutusV2\.TxInInfo\.[0-9]*\.pd\.json$/g,
        ),
        Utils.mkFromToAssertGolden(
          PreludeJson.parseJson,
          (v) =>
            LbrPlutusV1
              .IsPlutusData[LbrPlutusV2.TxInInfo]
              .fromData(LbrPrelude.Json[LbrPlutusV1.PlutusData].fromJson(v)),
          (v) =>
            LbrPrelude.Json[LbrPlutusV1.PlutusData].toJson(
              LbrPlutusV1
    ...
    it(`PlutusV2.OutputDatum from to golden tests`, async () => {
      await Utils.fromToGoldenTest(
        ...
        Utils.mkFromToAssertGolden(
          ...
          (v) =>
            LbrPlutusV1
              .IsPlutusData[LbrPlutusV2.OutputDatum]
              .fromData(LbrPrelude.Json[LbrPlutusV1.PlutusData].fromJson(v)),
          (v) =>
            LbrPrelude.Json[LbrPlutusV1.PlutusData].toJson(
              LbrPlutusV1
    ...
    it(`PlutusV2.TxOut from to golden tests`, async () => {
      await Utils.fromToGoldenTest(
        goldenDir,
        new Utils.RegExpFileFilter(
          /^PlutusV2\.TxOut\.[0-9]*\.pd\.json$/g,
        ),
        Utils.mkFromToAssertGolden(
          PreludeJson.parseJson,
          (v) =>
            LbrPlutusV1
              .IsPlutusData[LbrPlutusV2.TxOut]
              .fromData(LbrPrelude.Json[LbrPlutusV1.PlutusData].fromJson(v)),
          (v) =>
            LbrPrelude.Json[LbrPlutusV1.PlutusData].toJson(
              LbrPlutusV1
