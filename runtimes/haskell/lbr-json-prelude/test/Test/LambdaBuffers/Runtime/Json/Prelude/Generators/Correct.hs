module Test.LambdaBuffers.Runtime.Json.Prelude.Generators.Correct (genBool, genInteger, genChar, genText, genMaybe, genEither, genBytes, genList, genSet, genMap, genComplicated) where
