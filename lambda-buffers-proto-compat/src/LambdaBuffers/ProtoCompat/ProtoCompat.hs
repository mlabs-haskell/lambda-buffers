{-# LANGUAGE KindSignatures, DuplicateRecordFields #-}
...
import qualified Proto.Compiler as P
import qualified Proto.Compiler_Fields as P
...
instance IsMessage P.TyVar TyVar where
  ...
  toProto (TyVar vn si) = defMessage
...
instance IsMessage P.TyApp TyApp where
  ...
  toProto (TyApp tf args si) = defMessage
    & P.tyFunc     .~ toProto tf
...
instance IsMessage P.TyRef TyRef where
  ...
  toProto (TyRef inner si) = defMessage
    & P.sourceInfo .~ toProto si
    & case inner of
        LocalI lnm ->
...
instance IsMessage P.TyDef TyDef where
  ...
  toProto (TyDef tnm targs tbod si) = defMessage
    & P.tyName     .~ toProto tnm
...
instance IsMessage P.TyBody TyBody where
  ...
  toProto (TyBody inner si) = defMessage
    & P.sourceInfo .~ toProto si
    & case inner of
       OpaqueI opqsi ->
...
instance IsMessage P.Sum Sum where
  ...
  toProto (Sum ctors si) = defMessage
...
instance IsMessage P.Sum'Constructor Constructor where
  ...
  toProto (Constructor cnm prod) = defMessage
...
instance IsMessage P.Product'Record'Field Field where
  ...
  toProto (Field fnm fty) = defMessage
...
instance IsMessage P.ClassDef ClassDef where
  ...
  toProto (ClassDef cnm carg sups doc si) = defMessage
...
instance IsMessage P.InstanceClause InstanceClause where
  ...
  toProto (InstanceClause cnm hd csts si) = defMessage
    & P.className   .~ toProto cnm
...
instance IsMessage P.Constraint Constraint where
  ...
  toProto (Constraint cnm arg si) = defMessage
    & P.className  .~ toProto cnm
...
instance IsMessage P.Module Module where
  ...
  toProto (Module mnm tdefs cdefs insts si) = defMessage
    & P.moduleName .~ toProto mnm
...
instance IsMessage P.CompilerInput CompilerInput where
  ...
  toProto (CompilerInput ms) = defMessage
...
instance IsMessage P.TyName LBName where
  ...
  toProto (LBName tn si) = defMessage
    & P.name       .~ tn
    & P.sourceInfo .~ toProto si
