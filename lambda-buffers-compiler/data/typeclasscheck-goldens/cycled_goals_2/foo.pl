:- module('Foo',['Prelude.Eq'/1,'Prelude.Ord'/1]).
...
'Prelude.Ord'('app'('Foo.Foo','|'(Va,'|'(Vb,'[]')))) :-
  'Prelude.Ord'('sum'('|'('ctor'('FooA'
                                ,'tuple'('|'('app'('Foo.Foo'
                                                  ,'|'(Va,'|'(Vb,'[]')))
                                            ,'[]')))
                         ,'|'('ctor'('FooB'
                                    ,'tuple'('|'('app'('Foo.Foo'
                                                ...
                                                ,'[]')))
                             ,'[]'))))
  ,'Prelude.Eq'('app'('Foo.Foo','|'(Va,'|'(Vb,'[]')))).


'Prelude.Ord'('app'('Foo.Baz','|'(Va,'|'(Vb,'[]')))) :-
  'Prelude.Ord'('rec'('|'('field'('baz','app'('Foo.Baz','|'(Va,'|'(Vb,'[]'))))
                         ,'[]')))
  ,'Prelude.Eq'('app'('Foo.Baz','|'(Va,'|'(Vb,'[]')))).


'Prelude.Ord'('app'('Foo.Bar','|'(Va,'[]'))) :-
  'Prelude.Ord'('tuple'('|'('app'('Foo.Bar','|'(Va,'[]')),'[]')))
...
'Prelude.Eq'('app'('Foo.Baz','|'(Va,'|'(Vb,'[]')))) :-
  'Prelude.Eq'('rec'('|'('field'('baz','app'('Foo.Baz','|'(Va,'|'(Vb,'[]'))))
                        ,'[]'))).


'Prelude.Eq'('app'('Foo.Bar','|'(Va,'[]'))) :-
  'Prelude.Eq'('tuple'('|'('app'('Foo.Bar','|'(Va,'[]')),'[]'))).
