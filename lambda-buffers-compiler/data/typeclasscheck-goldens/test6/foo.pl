...
'Prelude.Ord'('app'('Foo.Foo','|'(Va,'|'(Vb,'|'(Vc,'[]'))))) :-
  'Prelude.Ord'('sum'('|'('ctor'('MkFoo'
                                ,'tuple'('|'('app'('Baz.Baz','|'(Va,'[]'))
                                            ,'|'(Vb,'|'(Vc,'[]')))))
                         ,'[]')))
  ,'Prelude.Eq'('app'('Foo.Foo','|'(Va,'|'(Vb,'|'(Vc,'[]'))))).


'Prelude.Ord'('app'('Baz.Baz','|'(Va,'[]'))) :-
  'Prelude.Ord'('sum'('|'('ctor'('MkBaz'
                                ,'tuple'('|'('app'('Bar.Bar','|'(Va,'[]'))
                                            ,'[]')))
                         ,'[]')))
  ,'Prelude.Eq'('app'('Baz.Baz','|'(Va,'[]'))).


'Prelude.Ord'('app'('Bar.Bar','|'(Va,'[]'))) :-
  'Prelude.Ord'(Va),'Prelude.Eq'('app'('Bar.Bar','|'(Va,'[]'))).
...
'Prelude.Eq'('app'('Baz.Baz','|'(Va,'[]'))) :-
  'Prelude.Eq'('sum'('|'('ctor'('MkBaz'
                               ,'tuple'('|'('app'('Bar.Bar','|'(Va,'[]'))
                                           ,'[]')))
                        ,'[]'))).


'Prelude.Eq'('app'('Bar.Bar','|'(Va,'[]'))) :-
  'Prelude.Eq'(Va).
