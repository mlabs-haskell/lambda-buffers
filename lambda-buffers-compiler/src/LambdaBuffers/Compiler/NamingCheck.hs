...
import Proto.Compiler_Fields (classNameErr, constrNameErr, fieldNameErr, moduleNameErr, tyNameErr, varNameErr)
import Proto.Lang (ClassName, ConstrName, FieldName, ModuleNamePart, TyName, VarName)
import Proto.Lang_Fields (name)
